...
export function FeaturesStats() {
  const features = [
    {
      icon: <Gem size={40} className="text-gold" />,
  ...
  return (
    <section className="py-32 bg-white border-b border-gray-100">
      <div className="container-premium px-4 sm:px-8 max-w-7xl mx-auto">
        {/* Countdown Timer */}
        <motion.div 
          className="flex flex-col md:flex-row items-center justify-center gap-4 bg-gold/5 p-8 rounded-lg mb-32 border border-gold/20"
        ...
        >
          ...
          <div className="flex gap-2">
            <div className="bg-gold text-black font-bold text-xl px-4 py-2 rounded-md min-w-15 text-center">
              {String(timeLeft.hours).padStart(2, '0')}h
            </div>
            <span className="text-gold font-bold text-xl py-2">:</span>
            <div className="bg-gold text-black font-bold text-xl px-4 py-2 rounded-md min-w-15 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center mb-24">
          {features.map((feature, idx) => (
            ...
            >
              ...
              <h3 className="text-gold font-bold text-xl mb-3 tracking-wide">{feature.title}</h3>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-gold font-black text-6xl md:text-7xl mb-3 tracking-wide">
            <AnimatedCounter from={0} to={458463} />
          </h2>
          <p className="text-gold font-bold text-xl tracking-wide">
